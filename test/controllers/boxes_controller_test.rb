...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post boxes_url, params: { box: { date_of_expiry: @box.date_of_expiry, filename: @box.filename, filepath: @box.filepath } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { date_of_expiry: @box.date_of_expiry, filename: @box.filename, filepath: @box.filepath } }
